...
hi("MiniStarterBl4cky", { fg = c.yellow_lt, bold = true })
hi("MiniStarterSection", { fg = c.pink, bold = true })
hi("MiniStarterItem", { fg = c.fg })
hi("MiniStarterItemBullet", { fg = c.fg_dim })
hi("MiniStarterItemPrefix", { fg = c.yellow_lt, bold = true })
hi("MiniStarterCurrent", { bg = c.bg_sel, bold = true })
hi("MiniStarterQuery", { fg = c.yellow_lt, bold = true })
hi("MiniStarterFooter", { fg = c.fg_dim, italic = true })
hi("MiniStarterInactive", { fg = c.fg_dim })

hi("RenderMarkdownH1", { fg = c.pink, bold = true })
hi("RenderMarkdownH2", { fg = c.yellow_lt, bold = true })
hi("RenderMarkdownH3", { fg = c.pink })
hi("RenderMarkdownH4", { fg = c.yellow_lt })
hi("RenderMarkdownH5", { fg = c.fg })
hi("RenderMarkdownH6", { fg = c.fg_dim })

hi("RenderMarkdownH1Bg", { bg = c.bg_sel })
hi("RenderMarkdownH2Bg", { bg = c.bg_alt })
hi("RenderMarkdownH3Bg", { bg = c.bg_alt })

hi("RenderMarkdownCode", { bg = c.bg_alt })
hi("RenderMarkdownCodeInline", { fg = c.yellow_lt, bg = c.bg_alt })
hi("RenderMarkdownBullet", { fg = c.pink })
hi("RenderMarkdownTableHead", { fg = c.pink, bold = true })
hi("RenderMarkdownTableRow", { fg = c.fg })
hi("RenderMarkdownQuote", { fg = c.yellow_lt, italic = true })
